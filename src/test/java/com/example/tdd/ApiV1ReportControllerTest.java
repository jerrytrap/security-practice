...
import com.example.tdd.domain.report.ApiV1ReportController;
...
public class ApiV1ReportControllerTest {
    ...
    void t19() throws Exception {
        ResultActions resultActions = mvc
                .perform(
                        get("/api/v1/reports?page=1&pageSize=3&searchKeywordType=content&searchKeyword=18명")
                )
                .andDo(print());
    ...
    void t20() throws Exception {
        ...
        ResultActions resultActions = mvc
                .perform(
                        get("/api/v1/reports/mine?page=1&pageSize=3")
                                .header("Authorization", "Bearer " + actor.getApiKey())
                )
                .andDo(print());
